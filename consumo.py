...
WALLET_PASS = os.environ.get("WALLET_PASSWORD") # Nueva variable
...
def init_db():
    ...
    try:
        # El DSN es el 'alias' (ej. housesavingdb_low)
        # oracledb usa TNS_ADMIN para encontrar la wallet
        # y wallet_password para abrirla.
        with oracledb.connect(user=DB_USER, password=DB_PASS, dsn=DB_DSN, wallet_password=WALLET_PASS) as conexion:
